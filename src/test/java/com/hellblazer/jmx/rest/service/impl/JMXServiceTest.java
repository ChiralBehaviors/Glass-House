...
public class JMXServiceTest {
	...
	private JMXServiceURL jmxServiceURL = JMXServiceURLUtils
			.getJMXServiceURL(address);
	...
	public void testGetHeapMemoryUsage() throws MalformedObjectNameException,
		...
		CompositeDataSupport compositeDataSupport = (CompositeDataSupport) service
				.getAttribute(jmxServiceURL,
						ManagementFactory.MEMORY_MXBEAN_NAME, "HeapMemoryUsage");
	...
	public void testGetJettyVersion() throws MalformedObjectNameException,
		...
		String version = (String) service.getAttribute(jmxServiceURL,
				JETTY_SERVER_MBEAN_NAME, "version");
	...
	public void testGetMBeanOperationInfo()
		...
		MBeanOperationInfo[] mBeanOperationInfos = service.getOperations(
				jmxServiceURL, JETTY_SERVER_MBEAN_NAME);
